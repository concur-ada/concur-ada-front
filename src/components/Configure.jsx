    ...
    <>
      ...
      <Jumbotron fluid>
        <Container>
          ...
          <p>Let's begin implementation!</p>
        </Container>
      </Jumbotron>
      ...
      <div
        ...
        className='container-fluid pageTitle'
      >
        <h1>Upload</h1>
        <br></br>
        <h6>
          Upload your company expense policy OR click to create new policy with
          the Concur Policy Builder
        </h6>
      </div>
      <div
        style={{ textAlign: 'center' }}
